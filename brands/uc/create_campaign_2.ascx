<%@ Control Language="C#" AutoEventWireup="true" CodeFile="create_campaign_2.ascx.cs" Inherits="brands_uc_create_campaign_2" %>

<div class="form-group">
    <table style="width:100%">
        <tr>
            <td style="background-color:#fafafa"><asp:CheckBox runat="server" ID="chk_Action_1" Text="&nbsp;Like Our Twitter Page" Checked="true" />
