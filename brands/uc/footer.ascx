<%@ Control Language="C#" AutoEventWireup="true" CodeFile="footer.ascx.cs" Inherits="brands_uc_footer" %>
   <footer role="contentinfo">
        <div class="container padding-t-md" style="padding-top: 30px;">
          <div class="row">
            ...
            <div class="col-sm-6 col-md-3 text-center">
              <div class="footer_logo">
                <img src='<%= SessionState.WebsiteURL %>images/footer_logo.png' alt="logo" />
              </div>
