<%@ Control Language="C#" AutoEventWireup="true" CodeFile="create_campaign_4.ascx.cs" Inherits="brands_uc_create_campaign_4" %>

<div class="form-group">
    <table style="width:100%">
        <tr>
            <td style="background-color:#fafafa">
                <asp:CheckBox runat="server" ID="chk_Action_1" Text="&nbsp;Favorite Our Twitter Page" Checked="true" />
                &nbsp;
                <asp:CheckBox runat="server" ID="chk_Action_2" Text="&nbsp;Favorite Our Twitter Post" Checked="true" />
                &nbsp;
                <asp:CheckBox runat="server" ID="chk_Action_3" Text="&nbsp;Retweet Our Twitter Post" Checked="true" />
        ...
        <tr>
            <td>
                <div>&nbsp</div>
                                                           ...
                                                           <div>
                                                               <div  class="col-md-12">
                                                                   <asp:DropDownList ID="drpPages5" runat="server" Width="250" AutoPostBack="True" OnSelectedIndexChanged="drpPages5_SelectedIndexChanged" >
                                                                    </asp:DropDownList> 
                                                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ErrorMessage="Select A Page"
                                             ControlToValidate="drpPages5" ValidationGroup="agent" InitialValue="0" ForeColor="Red"/>
                                                                   <asp:HiddenField ID="hiddenPageURL5" runat="server" />
                                                                   <asp:Label ID="lblNoPages5" runat="server" Visible="false" BorderStyle="Dotted">You have not configured any pages. Please goto settings and ADD PAGES.</asp:Label>
                                                               </div>
                                                           </div>
                                                       </div>
                                             ...
                                             ControlToValidate="txtSelectedPost" ValidationGroup="agent" InitialValue="" ForeColor="Red"/>
                                                                        ...
                                                                        <asp:Repeater ID="rep_PagePost5" runat="server" OnItemCommand="rep_PagePosts5_ItemCommand">                                                                            
                                                                            <ItemTemplate>                                                                                
                                                            ...
                                                            <asp:Label ID="lblPagePostsMsg5" runat="server" Visible="false" BorderStyle="Dotted"></asp:Label>
