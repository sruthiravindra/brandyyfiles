<%@ Control Language="C#" AutoEventWireup="true" CodeFile="create_campaign_10.ascx.cs" Inherits="brands_uc_create_campaign_10" %>
<div class="form-group">
    <table style="width:100%">
        <tr>
            <td style="background-color:#fafafa">
                <asp:CheckBox runat="server" ID="chk_Action_1" Text="&nbsp;Follow Our Insta Page" Checked="true" />
                &nbsp;
                <asp:CheckBox runat="server" ID="chk_Action_2" Text="&nbsp;Like Our Insta Post" Checked="true" />                
