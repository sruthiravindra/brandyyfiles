<%@ Control Language="C#" AutoEventWireup="true" CodeFile="create_campaign_9.ascx.cs" Inherits="brands_uc_create_campaign_9" %>
<div class="form-group">
    <table style="width:100%">
        <tr>
            <td style="background-color:#fafafa"><asp:CheckBox runat="server" ID="chk_Action_1" Text="&nbsp;Like Our Instagram Page" Checked="true" />
        ...
        <tr>
            <td>
                ...
                <div  class="col-md-12">                                                                                            
                    ...
                    <asp:Label ID="lblNoPages1" runat="server" Visible="false" BorderStyle="Dotted">You have not configured any pages. Please click on <a href="<%=SessionState.WebsiteURLBrand %>brand-create-page.aspx">ADD PAGES</a.</asp:Label>
                </div>  
            </td>
        </tr>
        <tr>
