<%@ Control Language="C#" AutoEventWireup="true" CodeFile="create_campaign_6.ascx.cs" Inherits="brands_uc_create_campaign_6" %>


<div class="form-group">
    <table style="width:100%">
        <tr>
            <td style="background-color:#fafafa"><asp:CheckBox runat="server" ID="chk_Action_1" Text="&nbsp;Visit Our Website" Checked="true" />
        ...
        <tr>
            <td>
               <label for="txtReward_1" class="control-label">
                Select Website * <i class="fa fa-info-circle"></i></label>
                <div  class="col-md-12">                                                                                            
                    ...
                    <asp:Label ID="lblNoPages1" runat="server" Visible="false" BorderStyle="Dotted">You have not configured any websites. Please click on <a href="<%=SessionState.WebsiteURLBrand %>socialmedias.aspx">ADD PAGES</a.</asp:Label>
                </div>
            </td>
        </tr>
        <tr>
