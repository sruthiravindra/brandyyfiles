...
public partial class brands_uc_create_campaign_9 : System.Web.UI.UserControl
{
    ...
    {
        Insta_Page_Likes(SessionState._Campaign.campaign_objective);

    }

    #region updatepanel-1

    private void Insta_Page_Likes(byte campaign_type)
    {
