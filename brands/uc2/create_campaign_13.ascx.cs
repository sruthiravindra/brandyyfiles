...
public partial class brands_uc2_create_campaign_13 : System.Web.UI.UserControl
{
    ...
    private void FillActionControls()
    {
        ...
        if (SessionState._Campaign.actions[campaign_type_1] != null)
        {
            DrpPages1.SelectedValue = SessionState._Campaign.actions[campaign_type_1].val1;
        }
    }
    ...
    {
        FB_Page_Likes(SessionState._Campaign.campaign_objective);

    }

    #region updatepanel-1

    private void FB_Page_Likes(byte campaign_type)
    {
        ...
        if (ConnObj.IsSuccess && ConnObj.DataSet.Tables.Count > 0 && ConnObj.DataSet.Tables[0].Rows.Count > 0)
        {
            ...
            lblNoPages1.Visible = false;
            btn_Next.Attributes.Remove("disabled");
        ...
        else
        {
            ...
            btn_Next.Attributes.Add("disabled", "disabled");
        }
    ...
    private void SetPanel1Session()
    {
        ...
        if (ConnObj.IsSuccess && ConnObj.DataSet.Tables.Count > 0 && ConnObj.DataSet.Tables[0].Rows.Count > 0)
        {
            ...
            ca.campaign_type = campaign_type_1;
    ...
    protected void btn_Next_Click(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "myJsFn", "setStep3()", true);
