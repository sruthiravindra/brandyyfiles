<%@ Control Language="C#" AutoEventWireup="true" CodeFile="create_campaign_11.ascx.cs" Inherits="brands_uc2_create_campaign_11" %>
            ...
            <td>                
                <div  class="col-md-12">
                    <div class="input-group" runat="server" id="divPage">
                                        <span class="input-group-addon" style="vertical-align:top">Specify Store Address</span>
                                        <asp:TextBox ID="txtCheckinUrl" runat="server" CssClass="form-control" placeholder="Checkin Url" Columns="50" TextMode="MultiLine" Rows="5"/>                                        
                                    </div>                    
