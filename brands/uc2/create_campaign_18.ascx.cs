...
public partial class brands_uc2_create_campaign_18 : System.Web.UI.UserControl
{
    ...
    protected void drpPages2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        String sm_page_id = Convert.ToString(ConnObj.DataSet.Tables[0].Rows[0]["sm_page_id"]);
    ...
    private void CreateOrUpdateActions(byte campaign_type)
    {
        ...
        {
            case 18: checked_status = chk_Action_3.Checked; break;
        }
