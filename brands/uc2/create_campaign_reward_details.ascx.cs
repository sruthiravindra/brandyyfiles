...
public partial class brands_create_campaign_reward_details : System.Web.UI.UserControl
{
    ...
    private void CreateAction(byte campaign_type)
    {
        ...
        cmd_across.Parameters.AddWithValue("@val_5", SessionState._Campaign.actions[campaign_type].val5);
        cmd_across.Parameters.AddWithValue("@val_6", SessionState._Campaign.actions[campaign_type].val6);
