<%@ Control Language="C#" AutoEventWireup="true" CodeFile="create_campaign_19.ascx.cs" Inherits="brands_uc2_create_campaign_19" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        <div class="input-group" runat="server" id="div1">
                                        <span class="input-group-addon">Any additional hashtags</span>
                        ...
                        <div class="input-group" runat="server" id="div2">
                                        <span class="input-group-addon">Any additional text</span>
                                        <asp:TextBox ID="txtDefaultText" OnTextChanged="txtDefaultText_TextChanged" AutoPostBack="true" runat="server" CssClass="form-control" placeholder="(Any Default Text The Post Should Contain?)" Columns="30"/>
                                    </div>
