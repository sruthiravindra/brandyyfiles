<%@ Page Language="C#" MasterPageFile="~/admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="activity-listing.aspx.cs" Inherits="brands_activity_listing" %>
                                                ...
                                                <ItemTemplate>                                         
                                                   <div  class="col-md-12">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12">                                                                                                            
                                                        ...
                                                        <p>&nbsp;</p>
                                                    <p>Verification: <small class='verification_status_<%#Eval("verification_status") %>' ><%#Eval("verification_status_str")%></small></p>                                                    
